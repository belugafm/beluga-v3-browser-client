    ...
    return (
        <>
            ...
            <style jsx>{`
                ...
                .modal-container {
                    background-color: ${getStyle(theme)["modalBackgroundColor"]};
                    color: ${getStyle(theme)["modalColor"]};
                }
                .triangle {
                    background-color: ${getStyle(theme)["modalBackgroundColor"]};
                }
                .button:hover {
                    background-color: ${getStyle(theme)["buttonHoverBgColor"]};
                }
                .button:hover svg {
                    stroke: ${getStyle(theme)["buttonHoverIconColor"]};
                    fill: ${getStyle(theme)["buttonHoverIconColor"]};
                }
            `}</style>
            <style jsx>{`
                .navigationbar {
