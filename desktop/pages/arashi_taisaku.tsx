        ...
        <>
            ...
            <div className="container">
                ...
                <div className="image-container">
                    <img className="ice-cream" src="/assets/images/something_went_wrong.png" />
                </div>
                <div className="description">
                    <p>
                        ...
                        チャット型SNSの性質上、悪意のあるユーザーを完全に排除することは難しく、Belugaは新規ユーザーの登録を停止し事実上閉鎖しました。
                    </p>
                    <p>
                        ...
                        このような基準になっているのは、Twitterアカウントを大量に取得し、かつ1年以上凍結されずに保持し続けることは難しいと考えたためです。
                    </p>
                    <p>
