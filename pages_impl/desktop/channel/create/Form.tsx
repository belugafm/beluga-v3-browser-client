...
import { getStyle as getContentStyle } from "../../../../component/desktop/chat/content/columns/Channel"
...
export const FormComponent = ({ channelGroup }: { channelGroup: ChannelGroupObjectT }) => {
